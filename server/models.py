...
class Prediction(db.Model):
    ...
    id_client = db.Column(db.Integer, db.ForeignKey('clientdataset.id_client', ondelete='CASCADE'), nullable=False)
    flag = db.Column(db.Integer)
    pred_flag = db.Column(db.Integer)
    prob_0 = db.Column(db.Float)
    prob_1 = db.Column(db.Float)
    clientdataset = db.relationship('ClientInfos', backref=db.backref('predictions', lazy=True, cascade='all, delete'))
